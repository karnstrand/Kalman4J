...
public class TestKalmanPosterior {
   ...
   public void testSmallMeasurementNoise() {
	  ...
	  assertEquals(1.0, post1.time(), 0.01); 
	  assertEquals(1.0, post1.mean().get(0, 0), 0.1); 
	  assertEquals(1.0, post1.mean().get(1, 0), 0.1); 
   ...
   public void testLargeMeasurementNoise() {
	  ...
	  assertEquals(1.0, post1.time(), 0.01); 
	  assertEquals(0.0, post1.mean().get(0, 0), 0.1); 
	  assertEquals(0.0, post1.mean().get(1, 0), 0.1); 
   ...
   public void testMediumMeasurementNoise() {
	  ...
	  P.set(3, 3, 0.000001);  
 	  ...
 	  assertEquals(1.0, post1.time(), 0.01); 
 	  assertEquals(0.5, post1.mean().get(0, 0), 0.1); 
 	  assertEquals(0.5, post1.mean().get(1, 0), 0.1); 
 	  assertTrue(post1.cov().det() < post0.cov().det());
